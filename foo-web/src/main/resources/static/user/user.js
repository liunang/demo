...
var loadData = function(){
	...
	var operateBtns = [];
	var pushBtn = {'btnName':'pushBtn','text':'<button class="btn btn-sm btn-success" style="background:#51A3FC;border:none;" onclick="rePwdFun(this)" title="密码重置">' +
			'重置' +
			'</button>'};
