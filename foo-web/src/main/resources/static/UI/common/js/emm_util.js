...
utilObj.util = function(){
	...
	this.sysAlert = function(msg){
		layer.alert(msg, {skin: 'layer-ext-myskin',
			area: ['400px', '250px'],
			offset: ['15vh', '30vw'],
			shade: 0.6,
			anim: 2, 
	...
	this.deleteView = function(fun){
		var delteViewLayer = layer.confirm('确定删除吗？',{
			title:'温馨提示',
			area: ['400px', '250px'],
			offset: ['15vh', '30vw'],
			shade: 0.6,
	...
	this.confirmView = function(fun,msg){
		var confirmViewLayer = layer.confirm(msg,{
			title:'温馨提示',
			area: ['400px', '250px'],
			offset: ['15vh', '30vw'],
			shade: 0.6,
	 ...
	 * 主页使用的确认框
	 */
	this.mainConfirmView = function(fun,msg){
		var confirmViewLayer = layer.confirm(msg,{
			title:'温馨提示',
			area: ['400px', '250px'],
			offset: ['15vh', '40vw'],
	...
	this.confirmAlert = function(fun,msg){
		var confirmViewLayer = layer.confirm(msg,{
			title:'温馨提示',
			area: ['400px', '250px'],
			offset: ['15vh', '30vw'],
