        ...
        if (BaseObjPool.getApplicationStatus() == BaseObjPool.APPLICATION_NORMAL) {
            ...
            if (loginBean != null) {
                ...
                if (userAuthIds != null && userAuthIds.size() > 0) {
                    ...
                    if (userAuthIds.containsValue(uri) || uri.equals("/menu/menuTreeByUser.action")||uri.equals("/login/getLoginUserInfo.action")||uri.equals("/user/updateUserSelfPassword.action")||uri.equals("/msgInfo/findByCondition.action")||uri.equals("/msgInfo/delMsgInfo.action")||uri.equals("/msgInfo/delMsgInfos.action")) {
